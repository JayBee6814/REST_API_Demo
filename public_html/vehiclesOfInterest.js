 ...
 */
    ...
    function refreshVOI(){  
        ...
        var value = document.getElementById("veh_value").value;
               ...
               voi = vois.documentElement.childNodes;
                    ...
                    switch (column) {
                        case "reason":
                            ...
                            if(vois.getElementsByTagName("reason")[(i*2) + 1].childNodes[0].nodeValue === value){
                        ...
                        case "model":
                            ...
                            if(vois.getElementsByTagName("model")[(i*2) + 1].childNodes[0].nodeValue === value){
                        ...
                        case "make":
                            ...
                            if(vois.getElementsByTagName("make")[(i*4) + 1].childNodes[0].nodeValue === value){
                        ...
                        case "licensePlate":
                            ...
                            if(vois.getElementsByTagName("licensePlate")[i].childNodes[0].nodeValue === value){
                        ...
                        case "vehYear":
                            ...
                            if(vois.getElementsByTagName("vehYear")[i].childNodes[0].nodeValue === value){
                        ...
                        case "color":
                            ...
                            if(vois.getElementsByTagName("color")[i].childNodes[0].nodeValue === value){
                        ...
                        case "ownersName":
                            ...
                            if(vois.getElementsByTagName("ownersName")[i].childNodes[0].nodeValue === value){
                        ...
                        case "ownersPhone":
                            ...
                            if(vois.getElementsByTagName("ownersPhone")[i].childNodes[0].nodeValue === value){
