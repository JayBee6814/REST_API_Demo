...
The purpose of the project was to create a fictional app for the Maryland State Police called Vehicles of Interest where they would use it to identify Vehicles that were flagged in their database. They could perform a mobile search of the database by field name and field value. Once a hit is found it is presented in an HTML Table. 
